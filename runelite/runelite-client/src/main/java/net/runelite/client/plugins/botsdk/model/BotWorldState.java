...
public class BotWorldState {
    ...
    private String gameState;       // LOGIN_SCREEN, LOADING, LOGGED_IN, etc.
    private int currentPlane;       // Floor level 0-3
    private int currentWorld;       // World number
    private String accountName;     // For farm tracking
